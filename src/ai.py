...
# Статусы для пользователя во время поиска («не молчим», §5.3). По просьбе заказчика
# без упоминания «интернета/источников» — нейтральные «обдумываю/формирую ответ».
_SEARCH_STATUSES = [
    "<i>Обдумываю ваш вопрос…</i>",
    "<i>Формирую ответ на ваш вопрос…</i>",
    "<i>Проверяю детали…</i>",
    "<i>Почти готово…</i>",
]
_FINALIZING = "<i>Формирую ответ на ваш вопрос…</i>"
