...
**Последнее обновление**: 2026-07-03 (закрыт Этап 4 — сбор ситуации, tag stage-4-done)
**Текущий этап**: Этап 5 — «Проверить работодателя» (☐ не начат)
**Следующий шаг**: Взять Этап 5 в работу — ветка меню «Проверить работодателя»: ввод названия / ИНН / ссылки → шаблонный промпт поверх агента поиска (Этап 3) → сводка из открытых источников + ссылки + оговорка «данные из открытых источников». Списание 1 запроса как обычный ответ; при balance=0 — в оплату; навигация «Проверить другого» / «Задать вопрос» / «Главное меню» без тупиков. Критерии — [`07_ROADMAP.md`](07_ROADMAP.md#этап-5--проверить-работодателя).
...
Пока нет. Этап 4 закрыт, ждём отмашку на старт Этапа 5.
